cmd /c pnpx openapi-zod-client typespec\out\spec-server.yaml --output web/apps/server/src/api --group-strategy=tag-file --strict-objects


@echo off
set "API_PATH=web/apps/server/src/api"
